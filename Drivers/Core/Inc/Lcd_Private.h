...
#define  LCD_Reset		             0x0030     // the Data Will Send by 8 bit and the Number of line is 1 and the Font is 5x8
#define  LCD_Set8Bit1Line5x11    	 0x0034     // the Data Will Send by 8 bit and the Number of line is 1 and the Font is 5x11
#define  LCD_Set8Bit2Line5x8     	 0x0038     // the Data Will Send by 8 bit and the Number of line is 2 and the Font is 5x8
#define  LCD_Set8Bit2Line5x11    	 0x003C     // the Data Will Send by 8 bit and the Number of line is 2 and the Font is 5x11
/*--------------------------------------------------------------------------------------------------------------------------------------------------*/
/*Display on/OFF and cursor*/
#define LCD_8BitDisplayOFF        0x0008  // D = 0    C = 0    B = 0    The Display is Off so Will Cursor is off  And Blinking is OFF
#define LCD_8BitDisplayON         0x000C  // D = 1    C = 0    B = 0    The Display is On But the Cursor is OFF so the Blinking is OFF
#define LCD_8BitCursorON     	  0x000E
#define LCD_8BitCursorBlinkON     0x000F
#define LCD_8BitCursorOFF     	  0x000C
...
/*------------------------------------------------------------------------------------------*/
/*Clear Display*/
#define LCD_8BitClearDisplay     0x0001
#define LCD_4BitClearDisplay     0x10

/*--------------------------------------------------------------------------------------------------------------------------------------------------*/
/*Entry Mode Set*/
#define LCD_8BitEntryMode1       0x0006 //  S = 0 (no screen shifting) & I/D = 1 (Increment cursor position)   /*Increment cursor (shift cursor to right)*/
#define LCD_8BitEntryMode2       0x0007 //  S = 1 (screen shifting) & I/D = 1 (Increment cursor position)   /*Increment cursor (shift cursor to right)*/
#define LCD_8BitEntryMode3       0x0005 //  S = 1 (screen shifting) & I/D = 0 (Decrement cursor position)   /*Decrement cursor (shift cursor to lift)*/
#define LCD_8BitEntryMode4       0x0004 //  S = 0 (no screen shifting) & I/D = 0 (Decrement cursor position)   /*Decrement cursor (shift cursor to lifts)*/
...
/*Set CG RAM Address*/
#define  LCD_SetAddressCGRAM      0x0040
/*---------------------------------------------------------------------------------------------------*/

/*Set DDRAM Address*/
#define  LCD_SetAddressDDRAM      0x0080
/*---------------------------------------------------------------------------------------------------*/
